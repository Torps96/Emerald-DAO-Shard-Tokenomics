...
We have provided the following example below to demonstrate this calculation. In this example we conservatively estimate the value of 1 $Shard in one year's time:
